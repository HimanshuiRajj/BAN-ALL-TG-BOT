...
photo3 = ""https://graph.org/LOGO-01-01-13
...
def sample_response(input_text):
  ...
  if user_message in ("hi", "hello", "sup", "hiii", "hii", "kha hai"):
    return f"{photo3}\n\
    hey! NOOB is not here i am HER Assistant wanna play with me"

  if user_message in ("NOOB", "NOOB", "@NO0B07", "MADARA"):
    return "HE is busy in her schedule. you can tell me i inform her"
  if user_message in ("bsdk", "madharchod", "bkl", "behanchod", "cgutiya",
                      "gaandu"):
    return "NOOB papa ke bina gaali mat bak aane de use"
